            ...
            <ul className="flex gap-11 text-3xl">
                <li className="text-5xl">
                    <a title="E-mail" href="mailto:mahdii.kariimiian@gmail.com">
                        <i className="hover:text-amber-600 transition fa-solid fa-envelope"></i>
                    </a>
                </li>
                ...
                <li className="text-5xl hover">
                    ...
                    >
                        <i className="hover:text-amber-600 transition fa-brands fa-telegram"></i>
                    </a>
                </li>
                ...
                <li className="text-5xl">
                    ...
                    >
                        <i className="hover:text-amber-600 transition fa-brands fa-whatsapp"></i>
                    </a>
                </li>
            </ul>
        </div>
